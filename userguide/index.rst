...
of great use also to `OpenStreetMappers <http://www.osm.org>`_ as well as tourists that
want to keep a geo-diary. 

+-------------------------------------------+----------------------------------------------------------------------------------------------+
| .. figure:: 01_introduction/01_nexus5.png | The main aim of Geopaparazzi is to have a tool that:                                         |
|    :align: center                         |                                                                                              |
|    :width: 300px                          | * fits in any pocket and can be always at hand, when needed                                  |
|                                           | * gives the possibility to take georeferenced and possibly orientated pictures               |
|    Geopaparazzi on the Nexus 5            |   during a survey, with further possibility to import them into                              |
