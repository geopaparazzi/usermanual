...
[.text-center]
====
image::images/version_1_3_0/08_coach.png[scaledwidth=50%, width=50% align="center"]
...
From here GPS logs can be zoom to or it is possible to modify the style of the selected GPS log and visualize the profile (swipe log to the right) or deleted it (swipe log to the left).
...
It is now possible to decide to use the filtered logs in certain in the logs list. Just enter the GPS settings and enable the option.
...
[.text-center]
====
image::images/version_1_3_0/02_only_filtered.png[scaledwidth=30%, width=30%]
The options available to set the GPS logs view mode.
====
...
[.text-center]
====
image::images/version_1_3_0/03_only_orig.png[scaledwidth=30%, width=30%]
The options available to set the GPS logs view mode.
====
...
[.text-center]
====
image::images/version_1_3_0/04_both.png[scaledwidth=30%, width=30%]
The options available to set the GPS logs view mode.
====
...
[.text-center]
====
image::images/version_1_3_0/sld_02_layers.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_03_polygons.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_05_lines.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_07_points.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_08_points_map.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_09_theme.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_10_theme.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_11_theme_single_fts.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_12_theme_map.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_14_gpx.png[scaledwidth=60%, width=60%]
...
[.text-center]
====
image::images/version_1_3_0/sld_15_gpx_map.png[scaledwidth=60%, width=60%]
An example of the styling options of a GPX layer in SMASH.
====
