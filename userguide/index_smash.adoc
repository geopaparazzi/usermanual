...
======
[[img-ipad]]
image::smash/ipad/main_view.PNG[scaledwidth=70%, width=70%]
SMASH on the ipad
======
...
====
[[img-iphone]]
image::smash/iphone_xs/2020-03-31 08.19.45.png[scaledwidth=40%, width=40%]
SMASH on the IPhone.
====
...
====
[[img-android]]
image::smash/android/Screenshot_20200331-120554.png[scaledwidth=40%, width=40%]
...
include::installation_smash.adoc[]
include::main_view_smash.adoc[]
