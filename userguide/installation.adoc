...
* from your devices visit the https://github.com/geopaparazzi/geopaparazzi/releases[geopaparazzi releases page] making sure to load the desktop site (**not** the mobile site).
